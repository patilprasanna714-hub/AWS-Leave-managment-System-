...
declare const CreateIntegrationCommand_base: {
    new (input: CreateIntegrationCommandInput): import("@smithy/core/client").CommandImpl<CreateIntegrationCommandInput, CreateIntegrationCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateIntegrationCommandInput): import("@smithy/core/client").CommandImpl<CreateIntegrationCommandInput, CreateIntegrationCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
