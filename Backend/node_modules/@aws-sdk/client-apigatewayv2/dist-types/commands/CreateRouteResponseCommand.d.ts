...
declare const CreateRouteResponseCommand_base: {
    new (input: CreateRouteResponseCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteResponseCommandInput, CreateRouteResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRouteResponseCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteResponseCommandInput, CreateRouteResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
