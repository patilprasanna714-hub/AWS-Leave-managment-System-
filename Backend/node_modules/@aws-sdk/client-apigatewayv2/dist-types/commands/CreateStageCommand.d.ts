...
declare const CreateStageCommand_base: {
    new (input: CreateStageCommandInput): import("@smithy/core/client").CommandImpl<CreateStageCommandInput, CreateStageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateStageCommandInput): import("@smithy/core/client").CommandImpl<CreateStageCommandInput, CreateStageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
