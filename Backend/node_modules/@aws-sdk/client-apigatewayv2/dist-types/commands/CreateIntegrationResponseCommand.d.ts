...
declare const CreateIntegrationResponseCommand_base: {
    new (input: CreateIntegrationResponseCommandInput): import("@smithy/core/client").CommandImpl<CreateIntegrationResponseCommandInput, CreateIntegrationResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateIntegrationResponseCommandInput): import("@smithy/core/client").CommandImpl<CreateIntegrationResponseCommandInput, CreateIntegrationResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
