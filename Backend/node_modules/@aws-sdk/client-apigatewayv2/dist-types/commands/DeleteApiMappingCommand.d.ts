...
declare const DeleteApiMappingCommand_base: {
    new (input: DeleteApiMappingCommandInput): import("@smithy/core/client").CommandImpl<DeleteApiMappingCommandInput, DeleteApiMappingCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteApiMappingCommandInput): import("@smithy/core/client").CommandImpl<DeleteApiMappingCommandInput, DeleteApiMappingCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
