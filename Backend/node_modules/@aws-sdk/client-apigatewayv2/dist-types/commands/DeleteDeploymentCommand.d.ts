...
declare const DeleteDeploymentCommand_base: {
    new (input: DeleteDeploymentCommandInput): import("@smithy/core/client").CommandImpl<DeleteDeploymentCommandInput, DeleteDeploymentCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteDeploymentCommandInput): import("@smithy/core/client").CommandImpl<DeleteDeploymentCommandInput, DeleteDeploymentCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
