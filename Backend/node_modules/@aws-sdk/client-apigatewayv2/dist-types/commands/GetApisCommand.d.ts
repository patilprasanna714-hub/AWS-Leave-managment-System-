...
declare const GetApisCommand_base: {
    new (input: GetApisCommandInput): import("@smithy/core/client").CommandImpl<GetApisCommandInput, GetApisCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetApisCommandInput]): import("@smithy/core/client").CommandImpl<GetApisCommandInput, GetApisCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
