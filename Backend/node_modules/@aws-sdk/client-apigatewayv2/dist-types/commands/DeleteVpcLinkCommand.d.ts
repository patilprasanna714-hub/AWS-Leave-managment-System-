...
declare const DeleteVpcLinkCommand_base: {
    new (input: DeleteVpcLinkCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcLinkCommandInput, DeleteVpcLinkCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteVpcLinkCommandInput): import("@smithy/core/client").CommandImpl<DeleteVpcLinkCommandInput, DeleteVpcLinkCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
