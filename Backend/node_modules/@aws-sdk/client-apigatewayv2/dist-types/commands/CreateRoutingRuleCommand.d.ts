...
declare const CreateRoutingRuleCommand_base: {
    new (input: CreateRoutingRuleCommandInput): import("@smithy/core/client").CommandImpl<CreateRoutingRuleCommandInput, CreateRoutingRuleCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRoutingRuleCommandInput): import("@smithy/core/client").CommandImpl<CreateRoutingRuleCommandInput, CreateRoutingRuleCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
