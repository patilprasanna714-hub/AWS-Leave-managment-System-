...
declare const DeletePortalProductSharingPolicyCommand_base: {
    new (input: DeletePortalProductSharingPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeletePortalProductSharingPolicyCommandInput, DeletePortalProductSharingPolicyCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePortalProductSharingPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeletePortalProductSharingPolicyCommandInput, DeletePortalProductSharingPolicyCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
