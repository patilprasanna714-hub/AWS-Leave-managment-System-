...
declare const CreateProductPageCommand_base: {
    new (input: CreateProductPageCommandInput): import("@smithy/core/client").CommandImpl<CreateProductPageCommandInput, CreateProductPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateProductPageCommandInput): import("@smithy/core/client").CommandImpl<CreateProductPageCommandInput, CreateProductPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
