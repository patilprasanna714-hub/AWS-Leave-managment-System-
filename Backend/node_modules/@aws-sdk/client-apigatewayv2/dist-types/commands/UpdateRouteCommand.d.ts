...
declare const UpdateRouteCommand_base: {
    new (input: UpdateRouteCommandInput): import("@smithy/core/client").CommandImpl<UpdateRouteCommandInput, UpdateRouteCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateRouteCommandInput): import("@smithy/core/client").CommandImpl<UpdateRouteCommandInput, UpdateRouteCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
