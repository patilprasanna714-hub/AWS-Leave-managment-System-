...
declare const UpdateIntegrationCommand_base: {
    new (input: UpdateIntegrationCommandInput): import("@smithy/core/client").CommandImpl<UpdateIntegrationCommandInput, UpdateIntegrationCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateIntegrationCommandInput): import("@smithy/core/client").CommandImpl<UpdateIntegrationCommandInput, UpdateIntegrationCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
