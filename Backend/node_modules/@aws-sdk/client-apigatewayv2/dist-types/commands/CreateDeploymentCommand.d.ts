...
declare const CreateDeploymentCommand_base: {
    new (input: CreateDeploymentCommandInput): import("@smithy/core/client").CommandImpl<CreateDeploymentCommandInput, CreateDeploymentCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDeploymentCommandInput): import("@smithy/core/client").CommandImpl<CreateDeploymentCommandInput, CreateDeploymentCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
