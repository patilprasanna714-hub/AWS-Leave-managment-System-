...
declare const GetPortalProductSharingPolicyCommand_base: {
    new (input: GetPortalProductSharingPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetPortalProductSharingPolicyCommandInput, GetPortalProductSharingPolicyCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPortalProductSharingPolicyCommandInput): import("@smithy/core/client").CommandImpl<GetPortalProductSharingPolicyCommandInput, GetPortalProductSharingPolicyCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
