...
declare const UpdateAuthorizerCommand_base: {
    new (input: UpdateAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<UpdateAuthorizerCommandInput, UpdateAuthorizerCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<UpdateAuthorizerCommandInput, UpdateAuthorizerCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
