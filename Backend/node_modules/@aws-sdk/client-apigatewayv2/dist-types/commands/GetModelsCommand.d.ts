...
declare const GetModelsCommand_base: {
    new (input: GetModelsCommandInput): import("@smithy/core/client").CommandImpl<GetModelsCommandInput, GetModelsCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetModelsCommandInput): import("@smithy/core/client").CommandImpl<GetModelsCommandInput, GetModelsCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
