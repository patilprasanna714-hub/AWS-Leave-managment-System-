...
declare const GetVpcLinksCommand_base: {
    new (input: GetVpcLinksCommandInput): import("@smithy/core/client").CommandImpl<GetVpcLinksCommandInput, GetVpcLinksCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [GetVpcLinksCommandInput]): import("@smithy/core/client").CommandImpl<GetVpcLinksCommandInput, GetVpcLinksCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
