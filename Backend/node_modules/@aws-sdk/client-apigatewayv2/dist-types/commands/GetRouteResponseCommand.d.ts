...
declare const GetRouteResponseCommand_base: {
    new (input: GetRouteResponseCommandInput): import("@smithy/core/client").CommandImpl<GetRouteResponseCommandInput, GetRouteResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRouteResponseCommandInput): import("@smithy/core/client").CommandImpl<GetRouteResponseCommandInput, GetRouteResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
