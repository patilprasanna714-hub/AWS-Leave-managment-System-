...
declare const UpdateProductRestEndpointPageCommand_base: {
    new (input: UpdateProductRestEndpointPageCommandInput): import("@smithy/core/client").CommandImpl<UpdateProductRestEndpointPageCommandInput, UpdateProductRestEndpointPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateProductRestEndpointPageCommandInput): import("@smithy/core/client").CommandImpl<UpdateProductRestEndpointPageCommandInput, UpdateProductRestEndpointPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
