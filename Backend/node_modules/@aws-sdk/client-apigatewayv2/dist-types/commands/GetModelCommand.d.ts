...
declare const GetModelCommand_base: {
    new (input: GetModelCommandInput): import("@smithy/core/client").CommandImpl<GetModelCommandInput, GetModelCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetModelCommandInput): import("@smithy/core/client").CommandImpl<GetModelCommandInput, GetModelCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
