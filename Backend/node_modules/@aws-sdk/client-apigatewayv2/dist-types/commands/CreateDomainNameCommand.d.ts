...
declare const CreateDomainNameCommand_base: {
    new (input: CreateDomainNameCommandInput): import("@smithy/core/client").CommandImpl<CreateDomainNameCommandInput, CreateDomainNameCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateDomainNameCommandInput): import("@smithy/core/client").CommandImpl<CreateDomainNameCommandInput, CreateDomainNameCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
