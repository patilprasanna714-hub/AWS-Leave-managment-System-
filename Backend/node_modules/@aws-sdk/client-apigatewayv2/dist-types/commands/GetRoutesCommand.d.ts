...
declare const GetRoutesCommand_base: {
    new (input: GetRoutesCommandInput): import("@smithy/core/client").CommandImpl<GetRoutesCommandInput, GetRoutesCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRoutesCommandInput): import("@smithy/core/client").CommandImpl<GetRoutesCommandInput, GetRoutesCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
