...
declare const PutPortalProductSharingPolicyCommand_base: {
    new (input: PutPortalProductSharingPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutPortalProductSharingPolicyCommandInput, PutPortalProductSharingPolicyCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutPortalProductSharingPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutPortalProductSharingPolicyCommandInput, PutPortalProductSharingPolicyCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
