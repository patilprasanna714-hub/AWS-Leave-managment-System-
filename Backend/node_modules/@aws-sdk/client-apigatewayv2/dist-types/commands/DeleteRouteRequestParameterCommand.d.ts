...
declare const DeleteRouteRequestParameterCommand_base: {
    new (input: DeleteRouteRequestParameterCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteRequestParameterCommandInput, DeleteRouteRequestParameterCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRouteRequestParameterCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteRequestParameterCommandInput, DeleteRouteRequestParameterCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
