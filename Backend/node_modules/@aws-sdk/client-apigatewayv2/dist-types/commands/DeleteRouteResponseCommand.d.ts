...
declare const DeleteRouteResponseCommand_base: {
    new (input: DeleteRouteResponseCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteResponseCommandInput, DeleteRouteResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRouteResponseCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteResponseCommandInput, DeleteRouteResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
