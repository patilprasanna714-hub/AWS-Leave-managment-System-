...
declare const DeleteCorsConfigurationCommand_base: {
    new (input: DeleteCorsConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteCorsConfigurationCommandInput, DeleteCorsConfigurationCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCorsConfigurationCommandInput): import("@smithy/core/client").CommandImpl<DeleteCorsConfigurationCommandInput, DeleteCorsConfigurationCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
