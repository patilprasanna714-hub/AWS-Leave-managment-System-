...
declare const GetPortalProductCommand_base: {
    new (input: GetPortalProductCommandInput): import("@smithy/core/client").CommandImpl<GetPortalProductCommandInput, GetPortalProductCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPortalProductCommandInput): import("@smithy/core/client").CommandImpl<GetPortalProductCommandInput, GetPortalProductCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
