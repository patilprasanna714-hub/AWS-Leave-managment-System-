...
declare const ReimportApiCommand_base: {
    new (input: ReimportApiCommandInput): import("@smithy/core/client").CommandImpl<ReimportApiCommandInput, ReimportApiCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ReimportApiCommandInput): import("@smithy/core/client").CommandImpl<ReimportApiCommandInput, ReimportApiCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
