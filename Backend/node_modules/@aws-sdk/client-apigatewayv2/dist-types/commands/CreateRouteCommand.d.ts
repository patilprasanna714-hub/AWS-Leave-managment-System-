...
declare const CreateRouteCommand_base: {
    new (input: CreateRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteCommandInput, CreateRouteCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateRouteCommandInput): import("@smithy/core/client").CommandImpl<CreateRouteCommandInput, CreateRouteCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
