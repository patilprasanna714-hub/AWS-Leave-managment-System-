...
declare const CreateAuthorizerCommand_base: {
    new (input: CreateAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<CreateAuthorizerCommandInput, CreateAuthorizerCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<CreateAuthorizerCommandInput, CreateAuthorizerCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
