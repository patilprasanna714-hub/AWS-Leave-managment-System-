...
declare const ResetAuthorizersCacheCommand_base: {
    new (input: ResetAuthorizersCacheCommandInput): import("@smithy/core/client").CommandImpl<ResetAuthorizersCacheCommandInput, ResetAuthorizersCacheCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ResetAuthorizersCacheCommandInput): import("@smithy/core/client").CommandImpl<ResetAuthorizersCacheCommandInput, ResetAuthorizersCacheCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
