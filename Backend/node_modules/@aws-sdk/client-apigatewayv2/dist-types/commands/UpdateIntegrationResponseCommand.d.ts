...
declare const UpdateIntegrationResponseCommand_base: {
    new (input: UpdateIntegrationResponseCommandInput): import("@smithy/core/client").CommandImpl<UpdateIntegrationResponseCommandInput, UpdateIntegrationResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateIntegrationResponseCommandInput): import("@smithy/core/client").CommandImpl<UpdateIntegrationResponseCommandInput, UpdateIntegrationResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
