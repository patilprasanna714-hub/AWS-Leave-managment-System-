...
declare const UpdateProductPageCommand_base: {
    new (input: UpdateProductPageCommandInput): import("@smithy/core/client").CommandImpl<UpdateProductPageCommandInput, UpdateProductPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateProductPageCommandInput): import("@smithy/core/client").CommandImpl<UpdateProductPageCommandInput, UpdateProductPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
