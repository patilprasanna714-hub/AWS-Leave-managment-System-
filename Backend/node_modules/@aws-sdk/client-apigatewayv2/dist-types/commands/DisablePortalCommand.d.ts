...
declare const DisablePortalCommand_base: {
    new (input: DisablePortalCommandInput): import("@smithy/core/client").CommandImpl<DisablePortalCommandInput, DisablePortalCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DisablePortalCommandInput): import("@smithy/core/client").CommandImpl<DisablePortalCommandInput, DisablePortalCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
