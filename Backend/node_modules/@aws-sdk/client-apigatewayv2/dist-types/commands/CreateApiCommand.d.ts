...
declare const CreateApiCommand_base: {
    new (input: CreateApiCommandInput): import("@smithy/core/client").CommandImpl<CreateApiCommandInput, CreateApiCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateApiCommandInput): import("@smithy/core/client").CommandImpl<CreateApiCommandInput, CreateApiCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
