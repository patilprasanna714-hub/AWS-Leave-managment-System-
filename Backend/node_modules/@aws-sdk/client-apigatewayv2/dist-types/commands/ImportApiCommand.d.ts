...
declare const ImportApiCommand_base: {
    new (input: ImportApiCommandInput): import("@smithy/core/client").CommandImpl<ImportApiCommandInput, ImportApiCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ImportApiCommandInput): import("@smithy/core/client").CommandImpl<ImportApiCommandInput, ImportApiCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
