...
declare const DeletePortalCommand_base: {
    new (input: DeletePortalCommandInput): import("@smithy/core/client").CommandImpl<DeletePortalCommandInput, DeletePortalCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePortalCommandInput): import("@smithy/core/client").CommandImpl<DeletePortalCommandInput, DeletePortalCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
