...
declare const GetRouteCommand_base: {
    new (input: GetRouteCommandInput): import("@smithy/core/client").CommandImpl<GetRouteCommandInput, GetRouteCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRouteCommandInput): import("@smithy/core/client").CommandImpl<GetRouteCommandInput, GetRouteCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
