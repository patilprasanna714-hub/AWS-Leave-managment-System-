...
declare const DeleteProductPageCommand_base: {
    new (input: DeleteProductPageCommandInput): import("@smithy/core/client").CommandImpl<DeleteProductPageCommandInput, DeleteProductPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteProductPageCommandInput): import("@smithy/core/client").CommandImpl<DeleteProductPageCommandInput, DeleteProductPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
