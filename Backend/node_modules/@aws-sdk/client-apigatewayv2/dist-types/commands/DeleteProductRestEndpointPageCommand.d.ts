...
declare const DeleteProductRestEndpointPageCommand_base: {
    new (input: DeleteProductRestEndpointPageCommandInput): import("@smithy/core/client").CommandImpl<DeleteProductRestEndpointPageCommandInput, DeleteProductRestEndpointPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteProductRestEndpointPageCommandInput): import("@smithy/core/client").CommandImpl<DeleteProductRestEndpointPageCommandInput, DeleteProductRestEndpointPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
