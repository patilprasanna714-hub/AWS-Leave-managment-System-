...
declare const UpdatePortalProductCommand_base: {
    new (input: UpdatePortalProductCommandInput): import("@smithy/core/client").CommandImpl<UpdatePortalProductCommandInput, UpdatePortalProductCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePortalProductCommandInput): import("@smithy/core/client").CommandImpl<UpdatePortalProductCommandInput, UpdatePortalProductCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
