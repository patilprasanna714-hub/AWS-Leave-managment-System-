...
declare const DeleteModelCommand_base: {
    new (input: DeleteModelCommandInput): import("@smithy/core/client").CommandImpl<DeleteModelCommandInput, DeleteModelCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteModelCommandInput): import("@smithy/core/client").CommandImpl<DeleteModelCommandInput, DeleteModelCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
