...
declare const GetProductRestEndpointPageCommand_base: {
    new (input: GetProductRestEndpointPageCommandInput): import("@smithy/core/client").CommandImpl<GetProductRestEndpointPageCommandInput, GetProductRestEndpointPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetProductRestEndpointPageCommandInput): import("@smithy/core/client").CommandImpl<GetProductRestEndpointPageCommandInput, GetProductRestEndpointPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
