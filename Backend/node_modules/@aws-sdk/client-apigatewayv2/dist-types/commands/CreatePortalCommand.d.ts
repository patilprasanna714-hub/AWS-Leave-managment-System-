...
declare const CreatePortalCommand_base: {
    new (input: CreatePortalCommandInput): import("@smithy/core/client").CommandImpl<CreatePortalCommandInput, CreatePortalCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePortalCommandInput): import("@smithy/core/client").CommandImpl<CreatePortalCommandInput, CreatePortalCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
