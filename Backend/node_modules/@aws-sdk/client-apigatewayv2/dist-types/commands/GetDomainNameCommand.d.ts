...
declare const GetDomainNameCommand_base: {
    new (input: GetDomainNameCommandInput): import("@smithy/core/client").CommandImpl<GetDomainNameCommandInput, GetDomainNameCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDomainNameCommandInput): import("@smithy/core/client").CommandImpl<GetDomainNameCommandInput, GetDomainNameCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
