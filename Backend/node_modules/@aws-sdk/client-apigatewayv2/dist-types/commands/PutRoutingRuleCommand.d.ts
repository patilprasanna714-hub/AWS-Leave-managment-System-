...
declare const PutRoutingRuleCommand_base: {
    new (input: PutRoutingRuleCommandInput): import("@smithy/core/client").CommandImpl<PutRoutingRuleCommandInput, PutRoutingRuleCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutRoutingRuleCommandInput): import("@smithy/core/client").CommandImpl<PutRoutingRuleCommandInput, PutRoutingRuleCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
