...
declare const ListPortalProductsCommand_base: {
    new (input: ListPortalProductsCommandInput): import("@smithy/core/client").CommandImpl<ListPortalProductsCommandInput, ListPortalProductsCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListPortalProductsCommandInput]): import("@smithy/core/client").CommandImpl<ListPortalProductsCommandInput, ListPortalProductsCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
