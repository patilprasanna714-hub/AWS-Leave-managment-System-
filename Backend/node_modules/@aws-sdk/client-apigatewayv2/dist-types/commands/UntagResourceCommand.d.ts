...
declare const UntagResourceCommand_base: {
    new (input: UntagResourceCommandInput): import("@smithy/core/client").CommandImpl<UntagResourceCommandInput, UntagResourceCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UntagResourceCommandInput): import("@smithy/core/client").CommandImpl<UntagResourceCommandInput, UntagResourceCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
