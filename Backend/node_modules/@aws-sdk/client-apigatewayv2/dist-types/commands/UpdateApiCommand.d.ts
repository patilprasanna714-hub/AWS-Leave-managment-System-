...
declare const UpdateApiCommand_base: {
    new (input: UpdateApiCommandInput): import("@smithy/core/client").CommandImpl<UpdateApiCommandInput, UpdateApiCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateApiCommandInput): import("@smithy/core/client").CommandImpl<UpdateApiCommandInput, UpdateApiCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
