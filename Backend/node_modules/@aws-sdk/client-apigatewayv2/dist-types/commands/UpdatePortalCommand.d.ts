...
declare const UpdatePortalCommand_base: {
    new (input: UpdatePortalCommandInput): import("@smithy/core/client").CommandImpl<UpdatePortalCommandInput, UpdatePortalCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdatePortalCommandInput): import("@smithy/core/client").CommandImpl<UpdatePortalCommandInput, UpdatePortalCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
