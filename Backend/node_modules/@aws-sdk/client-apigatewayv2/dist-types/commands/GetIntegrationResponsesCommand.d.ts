...
declare const GetIntegrationResponsesCommand_base: {
    new (input: GetIntegrationResponsesCommandInput): import("@smithy/core/client").CommandImpl<GetIntegrationResponsesCommandInput, GetIntegrationResponsesCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIntegrationResponsesCommandInput): import("@smithy/core/client").CommandImpl<GetIntegrationResponsesCommandInput, GetIntegrationResponsesCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
