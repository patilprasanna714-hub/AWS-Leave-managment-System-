...
declare const GetAuthorizerCommand_base: {
    new (input: GetAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<GetAuthorizerCommandInput, GetAuthorizerCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAuthorizerCommandInput): import("@smithy/core/client").CommandImpl<GetAuthorizerCommandInput, GetAuthorizerCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
