...
declare const UpdateDeploymentCommand_base: {
    new (input: UpdateDeploymentCommandInput): import("@smithy/core/client").CommandImpl<UpdateDeploymentCommandInput, UpdateDeploymentCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDeploymentCommandInput): import("@smithy/core/client").CommandImpl<UpdateDeploymentCommandInput, UpdateDeploymentCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
