...
declare const GetIntegrationResponseCommand_base: {
    new (input: GetIntegrationResponseCommandInput): import("@smithy/core/client").CommandImpl<GetIntegrationResponseCommandInput, GetIntegrationResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIntegrationResponseCommandInput): import("@smithy/core/client").CommandImpl<GetIntegrationResponseCommandInput, GetIntegrationResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
