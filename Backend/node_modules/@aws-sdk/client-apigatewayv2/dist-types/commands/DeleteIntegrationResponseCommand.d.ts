...
declare const DeleteIntegrationResponseCommand_base: {
    new (input: DeleteIntegrationResponseCommandInput): import("@smithy/core/client").CommandImpl<DeleteIntegrationResponseCommandInput, DeleteIntegrationResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIntegrationResponseCommandInput): import("@smithy/core/client").CommandImpl<DeleteIntegrationResponseCommandInput, DeleteIntegrationResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
