...
declare const UpdateDomainNameCommand_base: {
    new (input: UpdateDomainNameCommandInput): import("@smithy/core/client").CommandImpl<UpdateDomainNameCommandInput, UpdateDomainNameCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDomainNameCommandInput): import("@smithy/core/client").CommandImpl<UpdateDomainNameCommandInput, UpdateDomainNameCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
