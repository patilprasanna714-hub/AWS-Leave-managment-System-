...
declare const UpdateModelCommand_base: {
    new (input: UpdateModelCommandInput): import("@smithy/core/client").CommandImpl<UpdateModelCommandInput, UpdateModelCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateModelCommandInput): import("@smithy/core/client").CommandImpl<UpdateModelCommandInput, UpdateModelCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
