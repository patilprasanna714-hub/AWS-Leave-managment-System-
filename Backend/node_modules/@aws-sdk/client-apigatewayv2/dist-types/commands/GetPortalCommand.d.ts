...
declare const GetPortalCommand_base: {
    new (input: GetPortalCommandInput): import("@smithy/core/client").CommandImpl<GetPortalCommandInput, GetPortalCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPortalCommandInput): import("@smithy/core/client").CommandImpl<GetPortalCommandInput, GetPortalCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
