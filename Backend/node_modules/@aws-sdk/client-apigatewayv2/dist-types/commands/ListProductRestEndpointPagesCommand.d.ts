...
declare const ListProductRestEndpointPagesCommand_base: {
    new (input: ListProductRestEndpointPagesCommandInput): import("@smithy/core/client").CommandImpl<ListProductRestEndpointPagesCommandInput, ListProductRestEndpointPagesCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListProductRestEndpointPagesCommandInput): import("@smithy/core/client").CommandImpl<ListProductRestEndpointPagesCommandInput, ListProductRestEndpointPagesCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
