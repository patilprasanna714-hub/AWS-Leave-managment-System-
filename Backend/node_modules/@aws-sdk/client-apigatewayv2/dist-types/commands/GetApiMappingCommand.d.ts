...
declare const GetApiMappingCommand_base: {
    new (input: GetApiMappingCommandInput): import("@smithy/core/client").CommandImpl<GetApiMappingCommandInput, GetApiMappingCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetApiMappingCommandInput): import("@smithy/core/client").CommandImpl<GetApiMappingCommandInput, GetApiMappingCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
