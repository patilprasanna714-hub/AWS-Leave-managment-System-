...
declare const DeleteStageCommand_base: {
    new (input: DeleteStageCommandInput): import("@smithy/core/client").CommandImpl<DeleteStageCommandInput, DeleteStageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteStageCommandInput): import("@smithy/core/client").CommandImpl<DeleteStageCommandInput, DeleteStageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
