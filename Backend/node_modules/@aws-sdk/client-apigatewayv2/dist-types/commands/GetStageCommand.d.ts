...
declare const GetStageCommand_base: {
    new (input: GetStageCommandInput): import("@smithy/core/client").CommandImpl<GetStageCommandInput, GetStageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetStageCommandInput): import("@smithy/core/client").CommandImpl<GetStageCommandInput, GetStageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
