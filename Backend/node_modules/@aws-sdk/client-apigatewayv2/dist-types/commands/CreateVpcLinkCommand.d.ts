...
declare const CreateVpcLinkCommand_base: {
    new (input: CreateVpcLinkCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcLinkCommandInput, CreateVpcLinkCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateVpcLinkCommandInput): import("@smithy/core/client").CommandImpl<CreateVpcLinkCommandInput, CreateVpcLinkCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
