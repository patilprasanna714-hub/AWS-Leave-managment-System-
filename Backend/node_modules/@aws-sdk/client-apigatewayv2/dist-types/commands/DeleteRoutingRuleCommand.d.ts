...
declare const DeleteRoutingRuleCommand_base: {
    new (input: DeleteRoutingRuleCommandInput): import("@smithy/core/client").CommandImpl<DeleteRoutingRuleCommandInput, DeleteRoutingRuleCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRoutingRuleCommandInput): import("@smithy/core/client").CommandImpl<DeleteRoutingRuleCommandInput, DeleteRoutingRuleCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
