...
declare const ListProductPagesCommand_base: {
    new (input: ListProductPagesCommandInput): import("@smithy/core/client").CommandImpl<ListProductPagesCommandInput, ListProductPagesCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListProductPagesCommandInput): import("@smithy/core/client").CommandImpl<ListProductPagesCommandInput, ListProductPagesCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
