...
declare const GetDeploymentsCommand_base: {
    new (input: GetDeploymentsCommandInput): import("@smithy/core/client").CommandImpl<GetDeploymentsCommandInput, GetDeploymentsCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetDeploymentsCommandInput): import("@smithy/core/client").CommandImpl<GetDeploymentsCommandInput, GetDeploymentsCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
