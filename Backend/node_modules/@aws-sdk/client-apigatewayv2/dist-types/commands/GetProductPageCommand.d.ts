...
declare const GetProductPageCommand_base: {
    new (input: GetProductPageCommandInput): import("@smithy/core/client").CommandImpl<GetProductPageCommandInput, GetProductPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetProductPageCommandInput): import("@smithy/core/client").CommandImpl<GetProductPageCommandInput, GetProductPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
