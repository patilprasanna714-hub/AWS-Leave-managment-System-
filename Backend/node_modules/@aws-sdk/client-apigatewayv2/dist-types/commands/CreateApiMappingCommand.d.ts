...
declare const CreateApiMappingCommand_base: {
    new (input: CreateApiMappingCommandInput): import("@smithy/core/client").CommandImpl<CreateApiMappingCommandInput, CreateApiMappingCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateApiMappingCommandInput): import("@smithy/core/client").CommandImpl<CreateApiMappingCommandInput, CreateApiMappingCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
