...
declare const UpdateStageCommand_base: {
    new (input: UpdateStageCommandInput): import("@smithy/core/client").CommandImpl<UpdateStageCommandInput, UpdateStageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateStageCommandInput): import("@smithy/core/client").CommandImpl<UpdateStageCommandInput, UpdateStageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
