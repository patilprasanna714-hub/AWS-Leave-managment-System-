...
declare const GetIntegrationCommand_base: {
    new (input: GetIntegrationCommandInput): import("@smithy/core/client").CommandImpl<GetIntegrationCommandInput, GetIntegrationCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIntegrationCommandInput): import("@smithy/core/client").CommandImpl<GetIntegrationCommandInput, GetIntegrationCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
