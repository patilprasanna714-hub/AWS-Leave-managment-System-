...
declare const UpdateVpcLinkCommand_base: {
    new (input: UpdateVpcLinkCommandInput): import("@smithy/core/client").CommandImpl<UpdateVpcLinkCommandInput, UpdateVpcLinkCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateVpcLinkCommandInput): import("@smithy/core/client").CommandImpl<UpdateVpcLinkCommandInput, UpdateVpcLinkCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
