...
declare const PublishPortalCommand_base: {
    new (input: PublishPortalCommandInput): import("@smithy/core/client").CommandImpl<PublishPortalCommandInput, PublishPortalCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PublishPortalCommandInput): import("@smithy/core/client").CommandImpl<PublishPortalCommandInput, PublishPortalCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
