...
declare const GetModelTemplateCommand_base: {
    new (input: GetModelTemplateCommandInput): import("@smithy/core/client").CommandImpl<GetModelTemplateCommandInput, GetModelTemplateCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetModelTemplateCommandInput): import("@smithy/core/client").CommandImpl<GetModelTemplateCommandInput, GetModelTemplateCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
