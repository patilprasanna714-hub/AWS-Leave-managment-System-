...
declare const UpdateRouteResponseCommand_base: {
    new (input: UpdateRouteResponseCommandInput): import("@smithy/core/client").CommandImpl<UpdateRouteResponseCommandInput, UpdateRouteResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateRouteResponseCommandInput): import("@smithy/core/client").CommandImpl<UpdateRouteResponseCommandInput, UpdateRouteResponseCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
