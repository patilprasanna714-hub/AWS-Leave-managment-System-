...
declare const ExportApiCommand_base: {
    new (input: ExportApiCommandInput): import("@smithy/core/client").CommandImpl<ExportApiCommandInput, ExportApiCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ExportApiCommandInput): import("@smithy/core/client").CommandImpl<ExportApiCommandInput, ExportApiCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
