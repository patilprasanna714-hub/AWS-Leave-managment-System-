...
declare const DeleteIntegrationCommand_base: {
    new (input: DeleteIntegrationCommandInput): import("@smithy/core/client").CommandImpl<DeleteIntegrationCommandInput, DeleteIntegrationCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteIntegrationCommandInput): import("@smithy/core/client").CommandImpl<DeleteIntegrationCommandInput, DeleteIntegrationCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
