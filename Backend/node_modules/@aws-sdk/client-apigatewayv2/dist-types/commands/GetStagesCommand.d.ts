...
declare const GetStagesCommand_base: {
    new (input: GetStagesCommandInput): import("@smithy/core/client").CommandImpl<GetStagesCommandInput, GetStagesCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetStagesCommandInput): import("@smithy/core/client").CommandImpl<GetStagesCommandInput, GetStagesCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
