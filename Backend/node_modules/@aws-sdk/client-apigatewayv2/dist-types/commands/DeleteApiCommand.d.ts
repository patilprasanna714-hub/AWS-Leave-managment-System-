...
declare const DeleteApiCommand_base: {
    new (input: DeleteApiCommandInput): import("@smithy/core/client").CommandImpl<DeleteApiCommandInput, DeleteApiCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteApiCommandInput): import("@smithy/core/client").CommandImpl<DeleteApiCommandInput, DeleteApiCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
