...
declare const GetRoutingRuleCommand_base: {
    new (input: GetRoutingRuleCommandInput): import("@smithy/core/client").CommandImpl<GetRoutingRuleCommandInput, GetRoutingRuleCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRoutingRuleCommandInput): import("@smithy/core/client").CommandImpl<GetRoutingRuleCommandInput, GetRoutingRuleCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
