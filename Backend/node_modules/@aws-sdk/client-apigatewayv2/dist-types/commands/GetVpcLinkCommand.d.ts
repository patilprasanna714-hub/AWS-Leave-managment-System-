...
declare const GetVpcLinkCommand_base: {
    new (input: GetVpcLinkCommandInput): import("@smithy/core/client").CommandImpl<GetVpcLinkCommandInput, GetVpcLinkCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetVpcLinkCommandInput): import("@smithy/core/client").CommandImpl<GetVpcLinkCommandInput, GetVpcLinkCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
