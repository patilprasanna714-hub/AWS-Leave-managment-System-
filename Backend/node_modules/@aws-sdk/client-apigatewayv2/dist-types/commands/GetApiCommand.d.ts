...
declare const GetApiCommand_base: {
    new (input: GetApiCommandInput): import("@smithy/core/client").CommandImpl<GetApiCommandInput, GetApiCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetApiCommandInput): import("@smithy/core/client").CommandImpl<GetApiCommandInput, GetApiCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
