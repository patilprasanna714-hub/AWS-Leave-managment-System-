...
declare const GetRouteResponsesCommand_base: {
    new (input: GetRouteResponsesCommandInput): import("@smithy/core/client").CommandImpl<GetRouteResponsesCommandInput, GetRouteResponsesCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetRouteResponsesCommandInput): import("@smithy/core/client").CommandImpl<GetRouteResponsesCommandInput, GetRouteResponsesCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
