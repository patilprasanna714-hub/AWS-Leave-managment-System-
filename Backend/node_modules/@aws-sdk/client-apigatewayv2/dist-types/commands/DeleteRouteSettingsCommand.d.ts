...
declare const DeleteRouteSettingsCommand_base: {
    new (input: DeleteRouteSettingsCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteSettingsCommandInput, DeleteRouteSettingsCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRouteSettingsCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteSettingsCommandInput, DeleteRouteSettingsCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
