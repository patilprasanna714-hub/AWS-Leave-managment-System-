...
declare const DeletePortalProductCommand_base: {
    new (input: DeletePortalProductCommandInput): import("@smithy/core/client").CommandImpl<DeletePortalProductCommandInput, DeletePortalProductCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeletePortalProductCommandInput): import("@smithy/core/client").CommandImpl<DeletePortalProductCommandInput, DeletePortalProductCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
