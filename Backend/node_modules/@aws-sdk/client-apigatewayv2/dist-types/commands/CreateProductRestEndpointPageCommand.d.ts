...
declare const CreateProductRestEndpointPageCommand_base: {
    new (input: CreateProductRestEndpointPageCommandInput): import("@smithy/core/client").CommandImpl<CreateProductRestEndpointPageCommandInput, CreateProductRestEndpointPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateProductRestEndpointPageCommandInput): import("@smithy/core/client").CommandImpl<CreateProductRestEndpointPageCommandInput, CreateProductRestEndpointPageCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
