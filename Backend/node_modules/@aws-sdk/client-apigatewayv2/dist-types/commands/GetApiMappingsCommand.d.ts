...
declare const GetApiMappingsCommand_base: {
    new (input: GetApiMappingsCommandInput): import("@smithy/core/client").CommandImpl<GetApiMappingsCommandInput, GetApiMappingsCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetApiMappingsCommandInput): import("@smithy/core/client").CommandImpl<GetApiMappingsCommandInput, GetApiMappingsCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
