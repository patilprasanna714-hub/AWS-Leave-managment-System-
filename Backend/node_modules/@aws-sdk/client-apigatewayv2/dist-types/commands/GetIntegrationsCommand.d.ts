...
declare const GetIntegrationsCommand_base: {
    new (input: GetIntegrationsCommandInput): import("@smithy/core/client").CommandImpl<GetIntegrationsCommandInput, GetIntegrationsCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetIntegrationsCommandInput): import("@smithy/core/client").CommandImpl<GetIntegrationsCommandInput, GetIntegrationsCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
