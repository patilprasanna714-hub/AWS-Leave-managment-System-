...
declare const ListRoutingRulesCommand_base: {
    new (input: ListRoutingRulesCommandInput): import("@smithy/core/client").CommandImpl<ListRoutingRulesCommandInput, ListRoutingRulesCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListRoutingRulesCommandInput): import("@smithy/core/client").CommandImpl<ListRoutingRulesCommandInput, ListRoutingRulesCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
