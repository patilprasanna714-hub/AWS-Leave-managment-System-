...
declare const DeleteRouteCommand_base: {
    new (input: DeleteRouteCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteCommandInput, DeleteRouteCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteRouteCommandInput): import("@smithy/core/client").CommandImpl<DeleteRouteCommandInput, DeleteRouteCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
