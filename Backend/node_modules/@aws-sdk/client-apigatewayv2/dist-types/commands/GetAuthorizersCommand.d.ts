...
declare const GetAuthorizersCommand_base: {
    new (input: GetAuthorizersCommandInput): import("@smithy/core/client").CommandImpl<GetAuthorizersCommandInput, GetAuthorizersCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetAuthorizersCommandInput): import("@smithy/core/client").CommandImpl<GetAuthorizersCommandInput, GetAuthorizersCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
