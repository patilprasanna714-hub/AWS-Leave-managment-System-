...
declare const PreviewPortalCommand_base: {
    new (input: PreviewPortalCommandInput): import("@smithy/core/client").CommandImpl<PreviewPortalCommandInput, PreviewPortalCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PreviewPortalCommandInput): import("@smithy/core/client").CommandImpl<PreviewPortalCommandInput, PreviewPortalCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
