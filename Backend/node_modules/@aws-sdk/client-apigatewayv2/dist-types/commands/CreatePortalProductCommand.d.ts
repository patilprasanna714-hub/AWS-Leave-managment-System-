...
declare const CreatePortalProductCommand_base: {
    new (input: CreatePortalProductCommandInput): import("@smithy/core/client").CommandImpl<CreatePortalProductCommandInput, CreatePortalProductCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreatePortalProductCommandInput): import("@smithy/core/client").CommandImpl<CreatePortalProductCommandInput, CreatePortalProductCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
