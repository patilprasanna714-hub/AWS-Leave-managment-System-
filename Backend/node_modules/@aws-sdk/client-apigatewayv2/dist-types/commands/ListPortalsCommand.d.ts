...
declare const ListPortalsCommand_base: {
    new (input: ListPortalsCommandInput): import("@smithy/core/client").CommandImpl<ListPortalsCommandInput, ListPortalsCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListPortalsCommandInput]): import("@smithy/core/client").CommandImpl<ListPortalsCommandInput, ListPortalsCommandOutput, import("..").ApiGatewayV2ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
